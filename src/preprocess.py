...
def generate_data(classesList, numObjects, cropFilePaths, imageDir, cropImage, trainPickle, trainCSV,
	...
	pickle.dump(jpeg_frames_train, f, pickle.DEFAULT_PROTOCOL)
	f.close()
	f = open(testPickle, 'wb')
	pickle.dump(jpeg_frames_test, f, pickle.DEFAULT_PROTOCOL)
	f.close()
...
outNameCSV = "./data2/toybox_data_interpolated"
outNamePickle = "./data2/toybox_data_interpolated"
if crop:
	trainImagesName = outNameCSV + "_cropped_train.pickle"
	trainLabelsName = outNameCSV + "_cropped_train.csv"
	testImagesName = outNameCSV + "_cropped_test.pickle"
	testLabelsName = outNameCSV + "_cropped_test.csv"
	outNameCSV = outNameCSV + "_cropped.csv"
	outNamePickle = outNamePickle + "_cropped.pickle"
else:
...
csvFiles = ["toybox_rot_frames_interpolated.csv"]
# ["toybox_fps1_1080p_hodge_bbox.csv","toybox_fps1_1080p_rot_bbox.csv"]
