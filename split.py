...
trainLabelsFile = "./data/toybox_data_cropped_train.csv"
trainImagesFile = "./data/toybox_data_cropped_train.pickle"
devLabelsFile = "./data/toybox_data_cropped_dev.csv"
devImagesFile = "./data/toybox_data_cropped_dev.pickle"
valLabelsFile = "./data/toybox_data_cropped_val.csv"
valImagesFile = "./data/toybox_data_cropped_val.pickle"
